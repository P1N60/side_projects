...
smtp.login('victor.guldregn', 'prkm ynes psbu rjjh')
...
msg = message("Test of automatic email sender")

# Make a list of emails, where you wanna send mail
to = ['Oliver.lind.dk@gmail.com']

# Provide some data to the sendmail function!
smtp.sendmail(from_addr="victor.guldregn@gmail.com",
